...
sim.dir     <- file.path(base.dir, "outputs", "simresults", "work", "OR")
...
true.values <- array(dim = c(81, 6, true.params$master$num))


for (z in 11:dim(true.values)[3]) {

    cat(paste("\n\n\niteration", z, "\n\n\n"))

    pop <- do.call("..sim_work",
                   args = c(sim.basis,
