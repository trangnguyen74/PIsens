...
# This illustrative  from JOBS-II study,
...
# analysis data:
# as this is only to illustrate the sensitivity analyses, subset to complete cases
dat <- jobs %>%
    filter(complete==1) %>%
...
saveRDS(dat, file = here::here("research", "jobsII-analysis", "data", "jobsII.rds"))
